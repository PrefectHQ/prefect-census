...
from prefect_census.runs import CensusSyncRunCancelled, CensusSyncRunFailed, CensusSyncRunTimeout
from prefect_census.syncs import CensusSyncTriggerFailed, trigger_census_sync, trigger_census_sync_run_and_wait_for_completion
...
class TestTriggerCensusSyncRun:
    async def test_trigger_sync(self, respx_mock, census_credentials):
        ...
        @flow
        async def test_flow():
            return await trigger_census_sync(
...
class TestTriggerCensusSyncRunAndWaitForCompletion:
    async def test_run_success(self, respx_mock, census_credentials):
        respx_mock.post(
            ...
            return_value=Response(
                200, json={"data": {"id": 5, "sync_run_id": 12345}}
            )
        )
    ...
    async def test_run_success_with_wait(self, respx_mock, census_credentials):
        ...
        respx_mock.get(
            ...
            side_effect=[
                Response(200, json={"data": {"id": 5, "sync_run_id": 12345, "status": "working"}}),
                Response(200, json={"data": {"id": 5, "sync_run_id": 12345, "status": "working"}}),
                Response(200, json={"data": {"id": 5, "sync_run_id": 12345, "status": "completed"}}),
            ]
        )
    ...
    async def test_run_failure_with_wait(self, respx_mock, census_credentials):
        ...
        respx_mock.get(
            ...
            side_effect=[
                Response(200, json={"data": {"id": 5, "sync_run_id": 12345, "status": "working"}}),
                Response(200, json={"data": {"id": 5, "sync_run_id": 12345, "status": "working"}}),
                Response(200, json={"data": {"id": 5, "sync_run_id": 12345, "status": "failed"}}),
            ]
        )
    ...
    async def test_run_failure_no_run_id(self, respx_mock, census_credentials):
        respx_mock.post(
            ...
            return_value=Response(
                200, json={"data": {"id": 5, "status": "completed"}}
            )
        )
    ...
    async def test_run_cancelled_with_wait(self, respx_mock, census_credentials):
        ...
        respx_mock.get(
            ...
            side_effect=[
                Response(200, json={"data": {"id": 5, "sync_run_id": 12345, "status": "working"}}),
                Response(200, json={"data": {"id": 5, "sync_run_id": 12345, "status": "working"}}),
                Response(200, json={"data": {"id": 5, "sync_run_id": 12345, "status": "cancelled"}}),
            ]
        )
